...
import AssessmentActionForm from "./assessment-action-form";
...
import { setCurrentAssessment } from "@/src/store/features/assessmentsSlice";
...
export default function AssessmentDetailClient({ data }: AssessmentDetailClientProps) {
    ...
    const reduxAssessment = useSelector((state: RootState) => state.assessments.currentAssessment);
    const assessment = reduxAssessment || data;
